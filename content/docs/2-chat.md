...
CoverContent: <h1>Self-Hosted Conferencing</h1><h4>Audio Chat, Video Chat, Text Chat, Screen Sharing & more.</h4><code class='d-table br-5 bg-dark p-1 px-2 mt-5 mx-auto'>git clone https://github.com/platform-kit/chat</code>
