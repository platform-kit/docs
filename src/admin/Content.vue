            ...
            >
              ...
              <template #cell(thumbnail)="data">
                <span
                  ...
                  v-bind:style="{
                    'background-image':
                      'url(https://source.unsplash.com/random/160x90?t=' +
                      Date.now() +
...
export default {
  ...
  data() {
    return {
      ...
      window: null,
      items: [
        { title: "Blog Post", description: "This content is text only." },
        {
          title: "Podcast Episode 1",
          description: "This content has free audio.",
        },
        {
          title: "Podcast Episode 1 Extras",
          description: "This content has premium audio.",
        },
        {
          title: "Video Tutorial",
          description: "This content has premium video.",
        },
      ],
    };
  },
  ...
  methods: {
    myRowClickHandler(record, index) {
      ...
      this.window.location.href = "/admin/content/editor?id=" + record.id;
    },
  },
  computed: {
    rows() {
