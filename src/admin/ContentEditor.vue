          ...
          <b-card class="border-0 raised mb-3 mb-md-4">
            ...
            <div class="row">
              <div class="col-12">
                ...
                <b-textarea :disabled="isDisabled()" name="description" class="br-5 my-2"></b-textarea>
                <div class="badge badge-pill bg-light-blue">
                  <b-icon-credit-card class="mr-2"></b-icon-credit-card
                  >Subscription Required
                </div>
                <multiselect
                  :disabled="isDisabled()"
                  class="mt-2"
                  v-model="contentItem.subscriptionPlansRequired"
                  :options="[]"
                ></multiselect>
              </div>
            </div>
          ...
          <b-card class="border-0 raised mb-3 mb-md-4" title="Content">
            ...
            <b-tabs content-class="mt-3">
              ...
              <b-tab title="Premium Content">
                <small class="mb-3 d-block"
                  >This will be visible to search engines &amp; users who have
                  the required subscription.</small
                >
                <div
                  class="br-5"
                  v-bind:class="{ disabledCE: uiSettings.view == 'view' }"
