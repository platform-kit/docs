...
PlatformKit UI is a **static site generator**  and **serverless content management system** built with [VueJS](https://www.vuejs.org), [BootstrapVue](https://bootstrap-vue.org) and [Gridsome](https://www.gridsome.org).
